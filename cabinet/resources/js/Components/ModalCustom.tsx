...
const ModalCustom = ({ closeModal, text, children }: any) => {
    return (
        <Transition appear show={true} as={Fragment}>
            ...
            >
                <div className="min-h-screen px-4 text-center">
                    ...
                    >
                        <div className="inline-block w-full min-w-3xl max-w-3xl p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
