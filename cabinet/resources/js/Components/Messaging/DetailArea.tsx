...
function DetailArea() {
    return (
        <div className={style.detail_area}>
            <div className={style.detail_area_header}>
                ...
                <div className={style.detail_title}>CodePen Group</div>
                <div className={style.detail_subtitle}>
            ...
            <div className={style.detail_changes}>
                <input type="text" placeholder="Search in Conversation" />
                <div className={style.detail_change}>
                    Change Color
            ...
            <div className={style.detail_photos}>
                <div className={style.detail_photo_title}>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill="none"
                ...
                <div className={style.detail_photo_grid}>
